...
OverlayLoader.prototype.createOverlay = function () {
	...
	this.container = $("<div id='" + this.parent.options.overlayId + "' class='hidden_elem'></div>").css({
		width: "100%",
		height: "100%",
	...
	this.loadbar = $("<div id='qLbar' class='hidden_elem'></div>").css({
	...
	if (this.parent.options.percentage == true) {
		this.percentageContainer = $("<div id='qLpercentage' class='hidden_elem'></div>").text("0%").css({
			height: "40px",
			width: "100px",
			position: "absolute",
			fontSize: "3em",
...
OverlayLoader.prototype.updatePercentage = function (percentage) {
	...
	if (this.parent.options.percentage == true) {
		...
		$(".cir-yellow p").text(Math.ceil(percentage) + "%");
	}
};
